...
{
    public sealed class MaterialisedDemonstrative : Demonstrative
    {
        ...
        private MaterialisedDemonstrative() { }
        public MaterialisedDemonstrative(string singular, string plural)
        {
            _Singular = singular; 
            _Plural = plural;
        }
