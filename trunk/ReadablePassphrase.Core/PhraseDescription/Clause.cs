...
namespace MurrayGrant.ReadablePassphrase.PhraseDescription
{
    ...
    {
        public static readonly IDictionary<PhraseStrength, IEnumerable<PhraseStrength>> RandomMappings;
        ...
        static Clause()
        {
            ...
            RandomMappings = new Dictionary<PhraseStrength, IEnumerable<PhraseStrength>>();
            // Random is all the weighted strengths (not equal or required variations).
            RandomMappings.Add(PhraseStrength.Random, new[] 
            { 
                PhraseStrength.Normal,
                PhraseStrength.NormalAnd,
                PhraseStrength.NormalSpeech,
                PhraseStrength.Strong,
                PhraseStrength.StrongAnd,
                PhraseStrength.StrongSpeech,
                PhraseStrength.Insane,
                PhraseStrength.InsaneAnd,
                PhraseStrength.InsaneSpeech,
            });
            
            // The following are based on the median # charaters in the core strengths.
            // This can be generated by dumping statistics from the test app.
            RandomMappings.Add(PhraseStrength.RandomShort, new [] 
            { 
                PhraseStrength.Normal,
                PhraseStrength.NormalEqual,
                PhraseStrength.NormalRequired,
                PhraseStrength.Strong,
                PhraseStrength.Insane,
                PhraseStrength.StrongEqual,
            });
            RandomMappings.Add(PhraseStrength.RandomLong, new[] 
            { 
                PhraseStrength.NormalAnd,
                PhraseStrength.NormalSpeech,
                PhraseStrength.NormalEqualSpeech,
                PhraseStrength.NormalRequiredAnd,
                PhraseStrength.NormalRequiredSpeech,
                PhraseStrength.InsaneEqual,
                PhraseStrength.NormalEqualAnd,
                PhraseStrength.StrongRequired,
                PhraseStrength.StrongSpeech,
                PhraseStrength.StrongAnd,
            });
            RandomMappings.Add(PhraseStrength.RandomForever, new[] 
            { 
                PhraseStrength.StrongEqualSpeech,
                PhraseStrength.InsaneAnd,
                PhraseStrength.InsaneSpeech,
                PhraseStrength.StrongEqualAnd,
                PhraseStrength.InsaneRequired,
                PhraseStrength.StrongRequiredSpeech,
                PhraseStrength.InsaneEqualSpeech,
                PhraseStrength.InsaneEqualAnd,
                PhraseStrength.StrongRequiredAnd,
                PhraseStrength.InsaneRequiredSpeech,
                PhraseStrength.InsaneRequiredAnd,
            });
        }
        ...
        /// </summary>
        public static IEnumerable<Clause> CreatePhraseDescription(PhraseStrength strength, Random.RandomSourceBase randomness)
        {
            if (RandomMappings.ContainsKey(strength))
            {
                var keys = RandomMappings[strength];
                var choise = randomness.Next(keys.Count());
                var result = CreatePhraseDescription(keys.ElementAt(choise), randomness);
                return result;
            }
            else if (PredefinedPhraseDescriptions.ContainsKey(strength))
            {
                return PredefinedPhraseDescriptions[strength];
            }
            else
                throw new ArgumentException("Custom phrase strength must be created using CreateCollectionFromTextString().");
        }
            ...
            return new List<Clause>()
                {
                    new NounClause() { CommonNounFactor = 12, ProperNounFactor = 1, NounFromAdjectiveFactor = 2,
                                        ...
                                        NoNumberFactor = 5, NumberFactor = 1,
        ...
        public static IEnumerable<Clause> CreatePhraseDescriptionForNormalSpeech()
        {
            return new List<Clause>()
                {
                    new NounClause() { CommonNounFactor = 7, ProperNounFactor = 1, NounFromAdjectiveFactor = 0,
                                        SingularityFactor = 1, PluralityFactor = 0, 
        ...
        public static IEnumerable<Clause> CreatePhraseDescriptionForNormalEqualSpeech()
        {
            return new List<Clause>()
                {
                    new NounClause() { CommonNounFactor = 1, ProperNounFactor = 1, NounFromAdjectiveFactor = 0,
                                        SingularityFactor = 1, PluralityFactor = 0, 
            ...
            return new List<Clause>()
                {
                    new NounClause() { CommonNounFactor = 1, ProperNounFactor = 1, NounFromAdjectiveFactor = 1,
                                        SingularityFactor = 1, PluralityFactor = 0, 
                                        NoArticleFactor = 0, DefiniteArticleFactor = 1, IndefiniteArticleFactor = 1, DemonstractiveFactor = 0, PersonalPronounFactor = 1,
                                        NoNumberFactor = 0, NumberFactor = 1,
                                        NoAdjectiveFactor = 1, AdjectiveFactor = 0,
                                        NoPrepositionFactor = 1, PrepositionFactor = 0},
                    new VerbClause() { PresentFactor = 1, PastFactor = 1, FutureFactor = 1, ContinuousFactor = 0, ContinuousPastFactor = 0, PerfectFactor = 0, SubjunctiveFactor = 0,
                                        NoAdverbFactor = 1, AdverbFactor = 0,
            ...
            return new List<Clause>()
                {
                    new NounClause() { CommonNounFactor = 12, ProperNounFactor = 1, NounFromAdjectiveFactor = 2,
                                        ...
                                        NoNumberFactor = 4, NumberFactor = 1,
                                        NoAdjectiveFactor = 1, AdjectiveFactor = 0,
                                        NoPrepositionFactor = 1, PrepositionFactor = 0},
            ...
            return new List<Clause>()
                {
                    new NounClause() { CommonNounFactor = 8, ProperNounFactor = 0, NounFromAdjectiveFactor = 1,
                                        SingularityFactor = 7, PluralityFactor = 3, 
                                        NoArticleFactor = 5, DefiniteArticleFactor = 4, IndefiniteArticleFactor = 4, DemonstractiveFactor = 1, PersonalPronounFactor = 2,
                                        NoNumberFactor = 3, NumberFactor = 1,
                                        NoAdjectiveFactor = 6, AdjectiveFactor = 3,
                                        NoPrepositionFactor = 1, PrepositionFactor = 0},
