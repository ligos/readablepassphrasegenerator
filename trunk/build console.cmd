...
dotnet publish PassphraseGenerator -c Release -f net10.0

rem Build ZIP file for .NET 10.0
del /q PassphraseGenerator.net10.0.zip
copy /y ..\LICENSE.txt PassphraseGenerator\bin\Release\net10.0\publish\LICENSE.txt
copy /y ..\NOTICE.txt PassphraseGenerator\bin\Release\net10.0\publish\NOTICE.txt
copy /y README.txt PassphraseGenerator\bin\Release\net10.0\publish\README.txt
zip.exe -9j PassphraseGenerator.net10.0.zip PassphraseGenerator\bin\Release\net10.0\publish\*.* 
